      ...
      <div className="container">
        <Accordion defaultActiveKey={['0']} alwaysOpen className="border-radial">
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <p>Para começo de conversa, lembramos que o Hotel Rio das Garças não tem a estrutura de um Centro Mariápolis. Trata-se de um hotel que será adaptado às necessidades do congresso Gen. A escolha do hotel se baseou em várias pesquisas e foi a proposta mais econômica que encontramos para hospedagem e alimentação, além de estar localizado na região nordeste, que abriga a maior parte dos e das Gen do Brasil.</p>

              <p>Com relação aos quartos, o Hotel dispõe de 26 bangalôs (quartos), nos quais serão distribuídos em torno de 12 pessoas (por bangalô), em beliches. Para cada bangalô teremos um banheiro. Sendo assim, contamos com a iniciativa e caridade de cada um em organizar as filas de banheiro e banhos.</p>
